      ...
      <div>
        <div className="relative top-0">
          ...
          <div className="lg:top-36 top-20 absolute z-10 left-3 text-left">
            ...
            <p
              className={`${montserrat.className} text-white font-xs lg:font-semibold w-16 lg:w-2/3 lg:h-18`}
            >
              {overview.length > 260 ? <span>{overview.slice(0,260)}...</span> : <span>{overview}</span>}
            </p>
